<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ page
    ...
    <% String url="jdbc:oracle:thin:@localhost:1521:xe" ; String username="INVENTORY_502" ; String password="system" ;
      Connection Conn=DriverManager.getConnection(url, username, password); Statement stmt=Conn.createStatement();
      String query="select * from inventory" ; ResultSet s=stmt.executeQuery(query); %>
      <!DOCTYPE html>
      <html lang="en">
          ...
          <table id="inventoryTable" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
              ...
              <% while(s.next()){ %>
                <tr>
                  <td>
                    <%=s.getString("inventoryid")%>
                  </td>
                  <td>
                    <%=s.getString("inventoryname")%>
                  </td>
                  <td>
                    <%=s.getString("inventoryprice")%>
                  </td>
                  <td>
